...
class SearchPageViewModel extends ChangeNotifier {
  ...
  void navigateToNewsDetail(
      {required NewsModel model, required String titleCategory}) {
    navigationService
        .navigateTo(routeName: Routes.newsDetail, data: [titleCategory, model]);
  }

  void filterByAuthor(String v) {
    listNews = listNews
        .where((e) => e.author!.toLowerCase() == v.toLowerCase())
        .toList();
    notifyListeners();
  }
